...
function initSearchListener() {
    document.addEventListener("keydown", function (event) {
        if (event.key === "Enter") {
            ...
            // Esperar a que se actualice la tabla y luego recrear botones
            setTimeout(function() {
...
// ==================== 1. FUNCIÓN DE ENTER PARA BUSCAR (FIN) ====================


// ==================== 2. FUNCIÓN DE COPIAR TABLA DE PRODUCTOS (INICIO) ====================
function agregarBotonesCopiar() {
    ...
    filas.forEach(fila => {
        ...
        if (celdaProducto && !celdaProducto.querySelector('.btn-copiar-producto')) {
            ...
            botonCopiar.onclick = async (e) => {
                ...
                try {
                    ...
                    botonCopiar.innerHTML = '✓';
                    botonCopiar.style.backgroundColor = '#e92626';
                    setTimeout(() => {
                        botonCopiar.innerHTML = '📋';
                    ...
                    botonCopiar.innerHTML = '✓';
                    setTimeout(() => botonCopiar.innerHTML = '📋', 1500);
                }
            };
...
function observarTablaProductos() {
    const tablaContainer = document.querySelector('.tbl_stock_producto');
    ...
    observer.observe(tablaContainer, { childList: true, subtree: true });
    console.log('✅ Observer activado para detectar cambios en la tabla');
}

function initBotonesCopiar() {
    agregarBotonesCopiar();
    observarTablaProductos();
}
// ==================== 2. FUNCIÓN DE COPIAR TABLA DE PRODUCTOS (FIN) ====================


// ==================== 3. FUNCIÓN PARA REDIMENSIONAR TABLA (INICIO) ====================
function initRedimensionarTabla() {
...
// ==================== 3. FUNCIÓN PARA REDIMENSIONAR TABLA (FIN) ====================


// ==================== 4. ATAJOS DE TECLADO AltGr + S / AltGr + V (INICIO) ====================
function initAtajosEmpresas() {
    ...
    document.addEventListener('keyup', function(event) {
     ...
     // Esperar a que se actualice la tabla y luego recrear botones
            setTimeout(function() {
                initRedimensionarTabla();
            }, 500);
    console.log('✅ Atajos activados: AltGr + S → Soluciones, AltGr + V → Villafuerte');
}
// ==================== 4. ATAJOS DE TECLADO AltGr + S / AltGr + V (FIN) ====================


// ==================== 5. BOTÓN PARA CAMBIAR ENTRE EMPRESAS (INICIO) ====================
function initBotonCambioEmpresa() {
    ...
    if (document.getElementById('quickSwitchBtn')) return;
    ...
    console.log('✅ Botón de cambio agregado. Click o AltGr + C para cambiar de empresa');
}
// ==================== 5. BOTÓN PARA CAMBIAR ENTRE EMPRESAS (FIN) ====================


// ==================== 6. MENÚ DE ENGRANAJE Y ANALIZADOR EXCEL (INICIO) ====================
function initMenuEngranaje() {
    ...
    menu.innerHTML = `
        ...
        <div id="menuOption2" style="padding: 10px 12px; cursor: pointer; border-bottom: 1px solid #eee; display: flex; align-items: center; gap: 8px;">
            <span>📂</span> <span>Analizar Excel</span>
        </div>
...
// ==================== 6. MENÚ DE ENGRANAJE Y ANALIZADOR EXCEL (FIN) ====================
...
function inicializarTodo() {
    ...
    // Siempre inicializar el buscador y botones de copiar
    initSearchListener();
    initBotonesCopiar();
    ...
    // Solo donde existan los selectores de empresa
    if (document.querySelector('a.dropdown-item.d-block[href="/CompanyMaster/ChangeMasterCompany/1"]')) {
        initAtajosEmpresas();
        initBotonCambioEmpresa();
    }
    
    // Siempre inicializar el menú de engranaje
    initMenuEngranaje();
}
